...
const FileUploadModal = ({
    ...
    return (
        ...
        >
            <div className='flex w-full flex-col items-center justify-center border-dashed border-slate-700 text-slate-300 p-8'>
                <svg
            ...
            {
                upLoadSuccess && (
                    <p className='mt-2 text-green-600'>Upload Succesully</p>
                )
            }
            <span className='text-medium text-left text-white'>{filename}</span>
        </Modal>
    );
}
